            ...
            <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password"
                        aria-selected="false" role="tab" tabindex="-1">عرض و تغيير بيانات المرفق</button>
                </li>
            </ul>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mt-2">
                                    ...
                                    <select class="form-select mt-2" name="floor" aria-label="Default select example">
                                        <option value="الطابق الاول" @checked($room->floor == 'الطابق الاول')>الطابق الاول</option>
                                        <option value="الطابق الثاني" @checked($room->floor == 'الطابق الثاني')>الطابق الثاني</option>
                                        <option value="الطابق الثالث" @checked($room->floor == 'الطابق الثالث')>الطابق الثالث</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mt-2">
                                    ...
                                    <select class="form-select mt-2" name="type" aria-label="Default select example">
                                        <option value="معمل حاسوب" {{ $room->type == 'معمل حاسوب' ? 'selected' : '' }}>معمل
                                            حاسوب</option>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mt-2">
                                    ...
                                    <select class="form-select mt-2" name="available" aria-label="Default select example">
                                        ...
                                        <option value="0" {{ $room->available == 0 ? 'selected' : '' }}>غير مفعل
                                        </option>
                                    </select>
                                </div>
                            </div>
